...
$text['agenda_view']['config'][24] = 'Vous pouvez sélectionner ici un carnet d\'adresses au format csv avec séparateur virgule'.'<br/>'.'Les carnets doivent être placés dans le dossier site/file/source/agenda/adresses en utilisant le gestionnaire de fichiers de Deltacms';
$text['agenda_view']['config'][25] = 'Sélection d\'un fichier csv pour ajouter un carnet d\'adresses';

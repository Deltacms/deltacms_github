...
$text['agenda_view']['config'][24] = 'Here you can select an address book in csv format with comma separator'.'<br/>'.'The notebooks should be placed in the site/file/source/agenda/addresses folder using the Deltacms file manager';
$text['agenda_view']['config'][25] = 'Selecting a csv file to add an address book';
...
$text['agenda_view']['config'][38] = 'Choice of the color of the agenda grid';
$text['agenda_view']['config'][39] = 'Grid color';

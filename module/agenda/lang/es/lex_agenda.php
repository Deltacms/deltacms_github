...
$text['agenda_view']['config'][24] = 'Aquí puede seleccionar una libreta de direcciones en formato csv con separador de coma'.'<br/>'.'Los libros deben colocarse en el sitio /file/source/agenda/adresses usando el administrador de archivos de Deltacms';
$text['agenda_view']['config'][25] = 'Seleccione un archivo csv para agregar una libreta de direcciones';

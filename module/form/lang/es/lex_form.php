...
$text['form_view']['config'][38] = 'Anote en el campo de archivo la etiqueta del tipo y tamaño de los archivos autorizados. Las comprobaciones se realizan en archivos imagenes, pdf y zip, pero no en archivos txt. Precaución !';
...
$text['form_view']['index'][3] = 'Extensiones autorizadas';

$text['form_view']['texts'][0] = 'Regresar';
$text['form_view']['texts'][1] = 'Guardar';
$text['form_view']['texts'][2] = 'Adapte estos textos al idioma de sus visitantes';
$text['form_view']['texts'][4] = 'Enviar texto del botón';
$text['form_view']['texts'][5] = 'N° de versión ';

$text['form']['config'][0] = 'Cambios guardados';
$text['form']['config'][1] = 'Configuración del módulo';
$text['form']['texts'][0] = 'Textos visibles para un visitante';
$text['form']['texts'][1] = 'Textos registrados';
...
$text['form']['init'][0] = 'Captcha no válido';
$text['form']['init'][3] = 'Formulario enviado';
$text['form']['init'][4] = 'El archivo adjunto no es una imagen';
//$text['form']['index'][5] = '?';
$text['form']['init'][6] = 'El tamaño del archivo excede';
$text['form']['init'][7] = 'Este tipo de archivo no está permitido';
$text['form']['init'][8] = 'Error al cargar el archivo';

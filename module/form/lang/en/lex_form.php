...
$text['form_view']['config'][38] = 'Note in the label of the file field the type and size of files allowed. Checks are performed on pictures, pdf and zip files but not on txt files. Be careful!';
...
$text['form_view']['index'][3] = 'Allowed extensions';

$text['form_view']['texts'][0] = 'Back';
$text['form_view']['texts'][1] = 'Save';
$text['form_view']['texts'][2] = 'Adapt these texts to the language of your visitors';
$text['form_view']['texts'][4] = 'Submit button text';
$text['form_view']['texts'][5] = 'Version n° ';

$text['form']['config'][0] = 'Saved changes';
$text['form']['config'][1] = 'Module configuration';
$text['form']['texts'][0] = 'Texts visible to a visitor';
$text['form']['texts'][1] = 'Saved texts';
...
$text['form']['init'][0] = 'Wrong Captcha';
$text['form']['init'][3] = 'Form submitted';
$text['form']['init'][4] = 'File is not an image';
//$text['form']['index'][5] = '?';
$text['form']['init'][6] = 'File size exceeds';
$text['form']['init'][7] = 'This type of file is not allowed';
$text['form']['init'][8] = 'Error while uploading file' ;

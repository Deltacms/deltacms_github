...
$text['blog_view']['config'][18] = 'Block Border and Shadow';
$text['blog_view']['config'][19] = 'Apply the border and shadow set for the site\'s blocks to cover images';
...
$text['blog']['commentEdit'][0] = 'Comment edited';
$text['blog']['commentEdit'][1] = 'Comment on the article "';
$text['blog']['commentEdit'][2] = 'Action not allowed';
$text['blog']['commentEdit'][3] = '" by ';
$states = [
	false => 'Draft',
	true => 'Published'
];

...
$text['core_user_view']['add'][28] = 'Select \'Without redirection\' if you do not want a redirection.';
...
$text['core_user_view']['add'][33] = 'Password to be changed';
$text['core_user_view']['add'][34] = 'The user will be prompted to change their password after logging in';
...
$text['core_user_view']['edit'][28] = 'Select \'Without redirection\' if you do not want a redirection.';
...
$text['core_user_view']['edit'][36] = 'Password to be changed';
$text['core_user_view']['edit'][37] = 'The user will be prompted to change their password after logging in';
...
$text['core_user_view']['import'][6] = 'Send confirmation message even if password is saved';
...
$text['core_user_view']['import'][16] = 'Notification';
...
$text['core_user_view']['index'][8] = 'Export CSV';
...
$text['core_user_view']['login'][6] = 'Never use this option on a shared machine!';
...
$text['core_user']['add'][10] = 'Without redirection';
...
$text['core_user']['edit'][3] = 'Without redirection';
...
$text['core_user']['login'][8] = 'You must change your password';
...
$text['core_user']['import'][10] = 'Failure this identifier is already in use';
$text['core_user']['import'][11] = ', an email has been sent';
$text['core_user']['import'][12] = 'Temporary password to change: ';
$text['core_user']['import'][13] = 'Your password is unchanged';
$text['core_user']['import'][14] = 'Failed to create account';
$text['core_user']['import'][15] = 'Account created';
$text['core_user']['import'][16] = 'Account created with a temporary password';
$text['core_user']['export'][0] = 'List of users exported to ';
$text['core_user']['export'][1] = 'A problem has occurred';

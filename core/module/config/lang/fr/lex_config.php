...
$text['core_config_view']['connect'][22] = 'Mesure de l\'indice de confiance';
$text['core_config_view']['connect'][23] = 'Cette option permet aux formulaires de conditionner la soumission à un indice de confiance';
$text['core_config_view']['connect'][24] = 'Valider cette mesure';
$text['core_config_view']['connect'][25] = '200 derniers enregistrements';
...
$text['core_config_view']['index'][6] = 'Connexion Sécurité';
...
$text['core_config_view']['locale'][32] = 'Ce site utilise des cookies nécessaires à son fonctionnement, ils permettent de fluidifier son fonctionnement par exemple en mémorisant les données de connexion ou la validation de ce message.';
...
$text['core_config_view']['locale'][63] = 'Textes à adapter dans la langue de vos visiteurs ';
$text['core_config_view']['locale'][64] = 'Saisie obligatoire';
$text['core_config_view']['locale'][65] = 'Impossible de soumettre le formulaire, car il contient des erreurs';
$text['core_config_view']['locale'][66] = 'Commentaire soumis';
$text['core_config_view']['locale'][67] = 'Echec d\'envoi du commentaire';
$text['core_config_view']['locale'][68] = 'Captcha addition à 3 chiffres ';
$text['core_config_view']['locale'][69] = 'Texte au survol de la case réponse';
$text['core_config_view']['locale'][70] = 'Additionner les chiffres';
...
$text['core_config_view']['network'][6] = 'Paramètres à utiliser lorsque votre hébergeur ne propose pas la fonctionnalité d\'envoi de mail ou si votre hébergeur bloque vos mails suite aux contrôles de sécurité.';
...
$text['core_config_view']['mail'][0] = 'Nom de domaine utilisé par les courriels';
$text['core_config_view']['mail'][1] = 'Partie principale du nom de domaine comme "deltacms.fr"';
$text['core_config_view']['mail'][2] = 'Cette option est utile si la détermination automatique échoue. Laissez vide ou lire la documentation.';
$text['core_config_view']['mail'][3] = 'Détermination automatique du nom de domaine';
...
$text['core_config_view']['setup'][14] = 'Option activée la vérification est quotidienne. Option désactivée vous devrez faire les mises à jour par FTP. Si après une activation la case est décochée c\'est que la mise à jour en ligne est impossible.';
...
$text['core_config_view']['setup'][43] = "L'extension gd (traitement d'images) ne supporte pas le format avif";
$text['core_config_view']['setup'][44] = "Localisation actuelle: ";
$text['core_config_view']['setup'][45] = "L'extension gd (traitement d'images) supporte le format avif";
...
$text['core_config_view']['social'][3] = 'Générer sitemap.xml';
...
$text['core_config_view']['social'][6] = '<div class="blockTitle">Image screenshot.jpg absente</div><p>L\'activation du mode de capture Open Graph fait apparaître un appareil photo en bas de page. Un clic dessus génère une image screenshot.jpg à partir de la page active.</p>';
...
$text['core_config_view']['social'][41] = 'Outils SEO pour référencement';
$text['core_config_view']['social'][42] = 'Validation de ces outils';
$text['core_config_view']['social'][43] = 'Après validation il apparaît dans la barre d\'administration une nouvelle icône qui ouvre un volet d\'outils SEO décrits dans la documentation.';
$text['core_config_view']['social'][44] = 'Personnaliser le contenu du fichier robots.txt';
$text['core_config']['generateFiles'][0] = 'Mise à jour du fichier sitemap.xml';
...
$text['core_config']['index'][2] = 'Modifications enregistrées mais la recherche d\'une nouvelle version a échoué';

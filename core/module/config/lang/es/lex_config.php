...
$text['core_config_view']['connect'][22] = 'Medición del índice de confianza';
$text['core_config_view']['connect'][23] = 'Esta opción permite que los formularios condicionen el envío a un índice de confianza';
$text['core_config_view']['connect'][24] = 'Validar esta medición';
$text['core_config_view']['connect'][25] = 'Últimos 200 registros';
...
$text['core_config_view']['index'][4] = 'Localización';
$text['core_config_view']['index'][5] = 'Social';
$text['core_config_view']['index'][6] = 'Conexión Seguridad';
...
$text['core_config_view']['locale'][54] = 'Comentarios de la página ';
$text['core_config_view']['locale'][55] = 'Escribir un comentario';
$text['core_config_view']['locale'][56] = 'Nombre o apodo';
...
$text['core_config_view']['locale'][63] = 'Textos para adaptar al idioma de tus visitantes ';
$text['core_config_view']['locale'][64] = 'Entrada obligatoria';
$text['core_config_view']['locale'][65] = 'El formulario no se puede enviar porque contiene errores';
$text['core_config_view']['locale'][66] = 'Comentario enviado';
$text['core_config_view']['locale'][67] = 'Error al enviar el comentario';
$text['core_config_view']['locale'][68] = 'Captcha de suma de 3 dígitos ';
$text['core_config_view']['locale'][69] = 'Texto al pasar el cursor sobre el cuadro de respuesta';
$text['core_config_view']['locale'][70] = 'Suma los números';
...
$text['core_config_view']['setup'][14] = 'Opción activada la verificación es diaria. Opción desactivada tendrás que hacer las actualizaciones por FTP. Si después de la activación la casilla no está marcada, significa que la actualización en línea es imposible.';
...
$text['core_config_view']['setup'][43] = "La extensión gd (procesamiento de imágenes) no admite el formato avif";
$text['core_config_view']['setup'][44] = "Ubicación actual: ";
$text['core_config_view']['setup'][45] = "La extensión gd (procesamiento de imágenes) admite el formato avif";
...
$text['core_config_view']['social'][3] = 'Generar sitemap.xml';
...
$text['core_config_view']['social'][6] = '<div class="blockTitle">Imagen de captura de pantalla.jpg faltante</div><p>Al activar el modo de captura Open Graph, aparece una cámara en la parte inferior de la página. Al hacer clic en él, se genera una imagen de captura de pantalla.jpg de la página activa.</p>';
...
$text['core_config_view']['social'][41] = 'Herramientas SEO para la optimización en motores de búsqueda';
$text['core_config_view']['social'][42] = 'Validación de estas herramientas';
$text['core_config_view']['social'][43] = 'Después de la validación, aparece un nuevo icono en la barra de administración que abre un panel de herramientas SEO descritas en la documentación.';
$text['core_config_view']['social'][44] = 'Personaliza el contenido del archivo robots.txt';
$text['core_config']['generateFiles'][0] = 'Sitemap.xml actualizado';
...
$text['core_config']['index'][2] = 'Los cambios se guardaron pero falló la verificación de la nueva versión';

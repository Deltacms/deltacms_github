...
$text['core_config_view']['connect'][22] = 'Measuring the trust index';
$text['core_config_view']['connect'][23] = 'This option allows forms to condition submission on a trust index';
$text['core_config_view']['connect'][24] = 'Validate this measurement';
$text['core_config_view']['connect'][25] = 'Last 200 records';
...
$text['core_config_view']['index'][6] = 'Connection Security';
...
$text['core_config_view']['locale'][32] = 'This site uses cookies necessary for its operation, they allow to make its operation more fluid for example by memorizing the connection data or the validation of this message';
...
$text['core_config_view']['locale'][68] = '3 numbers addition captcha ';
$text['core_config_view']['locale'][69] = 'Text on hover over the answer box';
$text['core_config_view']['locale'][70] = 'Add the numbers';
...
$text['core_config_view']['network'][6] = 'Settings to use when your hosting provider does not offer email sending functionality or if your hosting provider blocks your emails following security checks';
...
$text['core_config_view']['mail'][0] = 'Domain name used by emails';
$text['core_config_view']['mail'][1] = 'Main part of the domain name like "deltacms.fr"';
$text['core_config_view']['mail'][2] = 'This option is useful if automatic determination fails. Leave blank or read the documentation.';
$text['core_config_view']['mail'][3] = 'Automatic domain name determination';
...
$text['core_config_view']['setup'][14] = 'Enabled option the check is daily. Option disabled you will have to do the updates by FTP. If after activation the box is unchecked, it means that the online update is impossible.';
...
$text['core_config_view']['social'][3] = 'Generate sitemap.xml';
...
$text['core_config_view']['social'][6] = '<div class="blockTitle">Image screenshot.jpg absent</div><p>Enabling the Open Graph capture mode causes a camera to appear at the bottom of the page. Clicking it generates a screenshot.jpg image from the active page.</p>';
...
$text['core_config_view']['social'][41] = 'SEO tools for search engine optimization';
$text['core_config_view']['social'][42] = 'Validation of these tools';
$text['core_config_view']['social'][43] = 'After validation, a new icon appears in the administration bar which opens a pane of SEO tools described in the documentation.';
$text['core_config_view']['social'][44] = 'Customize the content of the robots.txt file';
$text['core_config']['generateFiles'][0] = 'Updated sitemap.xml';
...
$text['core_config']['index'][2] = 'Changes saved but failed to find new version';

...
<?php if($module::$modInstal): ?>
	<?php echo template::table([2, 2, 1, 1, 3, 1 ], $module::$modInstal, [$text['core_addon_view']['index'][3], $text['core_addon_view']['index'][4], $text['core_addon_view']['index'][5], $text['core_addon_view']['index'][12], $text['core_addon_view']['index'][6], $text['core_addon_view']['index'][7]] ); ?>
<?php else: ?>

...
$text['core_theme_view']['addFonts'][8] = 'You must first upload the font file woff or woff2 to the fonts folder with the file manager';
...
$text['core_theme_view']['admin'][23] = "Link";
$text['core_theme_view']['admin'][24] = "Warning, this link appears in tables that always have a light background";
...
$text['core_theme_view']['body'][7] = 'Top and bottom icons background';
$text['core_theme_view']['body'][8] = 'Top and bottom icons';
...
$text['core_theme_view']['menu'][11] = 'Menu always visible';
...
$text['core_theme_view']['menu'][36] = 'Automatic active page background color';
...
$text['core_theme_view']['menu'][65] = 'Vertical offset of the menu';
$text['core_theme_view']['menu'][66] = 'Enter a positive integer representing the offset in pixels of the menu from the bottom of the banner. It is set at a minimum at the height of the menu.';
...
$text['core_theme_view']['site'][33] = 'Automatic scroll speed';
$text['core_theme_view']['site'][34] = 'Slow values allow the scroll to be stopped by a user action (clicking on the page, pressing a key, etc.)';
...
$text['core_theme']['import'][0] = 'The theme has been imported. If necessary reload the uncached page using Ctrl+F5 or equivalent.';

...
$text['core_theme_view']['admin'][23] = "Enlace";
$text['core_theme_view']['admin'][24] = "Advertencia: este enlace aparece en tablas que siempre tienen un fondo claro";
...
$text['core_theme_view']['advanced'][5] = "Encontrar un color";
...
$text['core_theme_view']['menu'][11] = 'Menú siempre visible';
...
$text['core_theme_view']['menu'][36] = 'Color de fondo automático de la página activa';
...
$text['core_theme_view']['menu'][65] = 'Desplazamiento vertical del menú';
$text['core_theme_view']['menu'][66] = 'Introduzca un número entero positivo que represente el desplazamiento en píxeles del menú desde la parte inferior del banner. Se establece como mínimo a la altura del menú.';
...
$text['core_theme']['import'][0] = 'El tema ha sido importado. Si es necesario, recarga la página sin caché utilizando Ctrl+F5 o equivalente.';

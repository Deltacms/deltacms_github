...
$text['core_theme_view']['addFonts'][8] = 'Vous devez au préalable téléverser le fichier de police woff ou woff2 dans le dossier fonts avec le gestionnaire de fichiers.';
...
$text['core_theme_view']['admin'][23] = "Lien";
$text['core_theme_view']['admin'][24] = "Attention, ce lien apparaît dans les tableaux qui ont toujours un fond clair";
...
$text['core_theme_view']['body'][7] = 'Fond des icônes haut et bas de page';
$text['core_theme_view']['body'][8] = 'Icônes haut et bas de page';
...
$text['core_theme_view']['menu'][11] = 'Menu toujours visible';
...
$text['core_theme_view']['menu'][27] = 'La couleur de fond de la page active peut être définie automatiquement ou selon une couleur définie, comme par exemple celle de fond des pages.';
...
$text['core_theme_view']['menu'][36] = 'Couleur de fond de la page active automatique';
...
$text['core_theme_view']['menu'][65] = 'Décalage vertical du menu';
$text['core_theme_view']['menu'][66] = 'Saisir un nombre entier positif représentant le décalage en pixels du menu par rapport au bas de la bannière. Il est au minimum fixé à la hauteur du menu.';
...
$text['core_theme_view']['site'][33] = 'Vitesse du scroll automatique';
$text['core_theme_view']['site'][34] = 'Les valeurs lentes permettent de stopper le scroll par une action de l\'utilisateur (clic sur la page, appuie sur une touche...)';
...
$text['core_theme']['import'][0] = 'Le thème a été importé. Si nécessaire rechargez la page sans cache par Ctrl+F5 ou équivalent.';

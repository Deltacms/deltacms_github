...
$text['core_page_view']['edit'][49] = 'Administrar';
...
$text['core_page_view']['edit'][54] = 'Instalando o actualizar un plugin';
$text['core_page_view']['edit'][55] = 'Administrar';
$text['core_page_view']['edit'][56] = 'Validar';
$text['core_page_view']['edit'][57] = 'Plugin en la parte superior de la página';
$text['core_page_view']['edit'][58] = 'Si está marcada, el plugin se mostrará en la parte superior de la página; de lo contrario, en la parte inferior';
...
$text['core_page_view']['comment'][8] = 'Nombre o apodo';
$text['core_page_view']['comment'][9] = 'Comentario';
$text['core_page_view']['comment'][10] = 'Fecha';
$text['core_page_view']['commentEdit'][0] = 'Atrás';
$text['core_page_view']['commentEdit'][1] = 'Guardar';
$text['core_page_view']['plugin'][1] = 'Atrás';
$text['core_page_view']['plugin'][2] = 'Plugin';
$text['core_page_view']['plugin'][3] = 'Documentación';
$text['core_page_view']['plugin'][4] = 'Texto para copiar y pegar en tu página o barra con Tinymce en modo código fuente';
$text['core_page_view']['plugin'][5] = 'No hay ningún plugin en esta página';
...
$text['core_page']['edit'][2] = 'Plugin ';
$text['core_page']['edit'][3] = ' instalado en tu página o barra. Copia y pega este texto ahí.';
$text['core_page']['edit'][4] = "Este no es un zip de plugin";
$text['core_page']['commentEdit'][0] = "Comentario modificado";
...
$text['core_page']['pluginDelete'][1] = 'Token incorrecto';
$text['core_page']['pluginDelete'][2] = 'Datos inexistentes';
$text['core_page']['pluginDelete'][3] = 'Plugin eliminado';
$text['core_page']['plugin'][1] = 'Cómo usar';
$text['core_page']['plugin'][2] = 'Copiar';
$text['core_page']['plugin'][3] = 'Nada que copiar';
$text['core_page']['plugin'][4] = 'Posición';
$text['core_page']['plugin'][5] = 'Arriba se muestra en la parte superior, debajo del título de la página; Abajo se muestra en la parte inferior';

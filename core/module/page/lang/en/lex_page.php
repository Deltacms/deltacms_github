...
$text['core_page_view']['edit'][49] = 'Manage';
...
$text['core_page_view']['edit'][54] = 'Installing or updating a plugin';
$text['core_page_view']['edit'][55] = 'Manage';
$text['core_page_view']['edit'][56] = 'Validate';
$text['core_page_view']['edit'][57] = 'Plugin at the top of the page';
$text['core_page_view']['edit'][58] = 'If checked, the plugin will be displayed at the top of the page, otherwise at the bottom of the page';
...
$text['core_page_view']['comment'][8] = 'Name or nickname';
$text['core_page_view']['comment'][9] = 'Comment';
$text['core_page_view']['comment'][10] = 'Date';
$text['core_page_view']['commentEdit'][0] = 'Back';
$text['core_page_view']['commentEdit'][1] = 'Save';
$text['core_page_view']['plugin'][1] = 'Back';
$text['core_page_view']['plugin'][2] = 'Plugin';
$text['core_page_view']['plugin'][3] = 'Documentation';
$text['core_page_view']['plugin'][4] = 'Text to copy and paste into your page or bar with Tinymce in source code mode';
$text['core_page_view']['plugin'][5] = 'No plugin on this page';
...
$text['core_page']['edit'][3] = ' installed on your page or bar. Copy and paste this text there.';
$text['core_page']['edit'][4] = "This is not a plugin zip";
$text['core_page']['commentEdit'][0] = "Comment edited";
...
$text['core_page']['pluginDelete'][1] = 'Incorrect token';
$text['core_page']['pluginDelete'][2] = 'Data does not exist';
$text['core_page']['pluginDelete'][3] = 'Plugin deleted';
$text['core_page']['plugin'][1] = 'How to use';
$text['core_page']['plugin'][2] = 'Copy';
$text['core_page']['plugin'][3] = 'Nothing to copy';
